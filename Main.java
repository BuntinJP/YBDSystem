...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        DiscordWebhook dw = new DiscordWebhook("https://discord.com/api/webhooks/1006994080812781700/Mn6RAP4BfOFxSBYHFpkA7pRET6XiNiSjYX25MzSKbH8iHu58sE2hok-Zib6mRBTYlDi2");
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            dw.addEmbed(new DiscordWebhook.EmbedObject().setTitle("YBD-System").setDescription(strDate)
